...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.kind'
        db.add_column('core_contact', 'kind', self.gf('django.db.models.fields.CharField')(default='', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.kind'
        db.delete_column('core_contact', 'kind')
